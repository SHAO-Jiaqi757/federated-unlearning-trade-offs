...
~/miniconda3/envs/openmmlab/bin/python ./main.py -c /home/jshaoaj/project/unlearning/benchmark_FU/configs/mnist_label_distritbuion_noniid_348/config_unlearn_retrain.yml
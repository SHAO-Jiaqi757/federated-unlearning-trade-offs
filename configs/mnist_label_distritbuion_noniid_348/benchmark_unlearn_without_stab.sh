...
# change to benchemark_FU directory
cd /home/jshaoaj/project/unlearning/benchmark_FU
# Run the Python script with arguments
~/miniconda3/envs/openmmlab/bin/python ./main.py -c /home/jshaoaj/project/unlearning/benchmark_FU/configs/mnist_label_distritbuion_noniid/config_unlearn_without_stab.yml --resume
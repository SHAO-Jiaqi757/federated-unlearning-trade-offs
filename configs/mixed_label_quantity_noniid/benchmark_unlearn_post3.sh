...
~/miniconda3/envs/openmmlab/bin/python ./main.py -c /home/jshaoaj/project/unlearning/benchmark_FU/configs/mixed_label_quantity_noniid/config_unlearn_post_stability_3.yml --resume